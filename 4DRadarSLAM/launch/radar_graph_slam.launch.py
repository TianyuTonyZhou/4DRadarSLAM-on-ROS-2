...
def generate_launch_description():
    ...
    enable_frontend_ego_vel   = LaunchConfiguration('enable_frontend_ego_vel',   default='false')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[config, {
                ...
                'gt_file_location': '/home/zhuge/datasets/Radar/gt_carpark1.txt',
            }]
        ),
        ...
        Node(
            ...
            parameters=[config, {
                ...
                'use_ego_vel': enable_frontend_ego_vel,
                'max_submap_frames': 5,
                'enable_scan_to_map': True,
                'enable_imu_fusion': False,
                'imu_debug_out': True,
                'imu_fusion_ratio': 0.1,
            }]
        ),
